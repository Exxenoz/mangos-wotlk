...
void MassiveObjectTransportBase::InitializePassengers()
{
...
void MassiveObjectTransportBase::DestroyAllPassengers()
{
...
Movement::Location MassiveObjectTransportBase::ComputePosition()
{
    float u = 1.f;
